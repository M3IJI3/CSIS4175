...
import com.example.primarydetaildemo.placeholder.PlaceholderContent;
import com.example.primarydetaildemo.databinding.FragmentWebsiteDetailBinding;
    ...
    private void updateContent() {
        if (mItem != null) {
            binding.websiteDetail.setWebViewClient(new WebViewClient(){
                public boolean shouldOverrideLoading(WebView view, WebResourceRequest request){
